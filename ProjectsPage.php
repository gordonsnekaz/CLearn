...
<body>
  ...
  <div class='w-5/6 float-right py-16 px-8'>
    ...
    <!-- welcome card -->
    <div class="bg-green-700 rounded-lg shadow-md w-full flex-1 px-8 pt-12 pb-16">
      <div class=''>
        <p class="font-medium text-2xl text-gray-300"> Projects </p>
      ...
      <div class='Progres'>
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 2 Courses</span>
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 29 Videos</span>
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 123+ Students Enrolled </span>
      </div>
    </div>

    <div class='pt-8 pb-4'>
      <p class='font-semibold text-md'> 3 New projects </p>
    </div>
